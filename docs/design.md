...
冷靛青、墨灰与暖铜延伸现有宋体排印，以帷幕和光形成与园林不同的阅读气氛。新增图像为内置 image_gen 生成的解释性意象，不声称复原具体历史场景；同一图像融合于首页入口、作品开篇及人物区。网页使用约92KB的WebP图像，来源提示保留在页面。

六条路径以三个场景并置说明判断、感情、承担、主体和记忆之间的张力，不把变化绘制为单向成长曲线。五幕精读逐场保存情节、细读、英文短引、释义与问题；人物区单列文本尚不能确定的范围。八篇札记保留文学语言、节奏、宗教语境与喜剧。原稿13、62、97段旁的提示以新补读明确标注，纯原文模式不显示它们。
