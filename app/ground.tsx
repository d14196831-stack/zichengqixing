...
export function Ground({read, explore, literature}: {read:(id:number, paragraph?:number)=>void; explore:()=>void; literature:OpenLiterature}) {
 ...
 return <div className="ground-view">
  ...
  <section className="hamlet-invitation"><img src="./hamlet-stage.webp" width="1536" height="1024" alt="" aria-hidden="true" loading="lazy"/><div><p className="eyebrow">新补读 / 哈姆雷特</p><h2>不做乐器，<br/>也不把人当乐器。</h2><p>一句洞见，也要回头照见说出它的人。<br/>从五幕二十场，理解主体、承担与生命的分量。</p></div><div className="hamlet-invitation-actions"><button onClick={()=>literature('hamlet','hamlet-person')}>从人的根基进入 <ArrowRight size={18}/></button><button onClick={()=>literature('hamlet','hamlet-scene-1-1')}>开始逐场精读 <ArrowUpRight size={18}/></button><span>英文全文补读 · 原文与细读并列</span></div></section>
